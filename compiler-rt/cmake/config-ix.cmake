...
set(ALL_MPK_UNTRUSTED_SUPPORTED_ARCH ${X86} ${X86_64})
...
if(APPLE)
  ...
  list_intersect(SHADOWCALLSTACK_SUPPORTED_ARCH
    ...
    SANITIZER_COMMON_SUPPORTED_ARCH)
  list_intersect(MPK_UNTRUSTED_SUPPORTED_ARCH
    ALL_MPK_UNTRUSTED_SUPPORTED_ARCH
    SANITIZER_COMMON_SUPPORTED_ARCH)
  ...
  filter_available_targets(SHADOWCALLSTACK_SUPPORTED_ARCH
    ${ALL_SHADOWCALLSTACK_SUPPORTED_ARCH})
  filter_available_targets(MPK_UNTRUSTED_SUPPORTED_ARCH ${ALL_MPK_UNTRUSTED_SUPPORTED_ARCH})
endif()
...
if (COMPILER_RT_HAS_SANITIZER_COMMON AND MPK_UNTRUSTED_SUPPORTED_ARCH)
  set(COMPILER_RT_HAS_MPK_UNTRUSTED TRUE)
else()
  set(COMPILER_RT_HAS_MPK_UNTRUSTED FALSE)
endif()
